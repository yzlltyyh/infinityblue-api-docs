...
<Steps>
  <Step title="Sign in">
    Open the [InfinityBlue dashboard](https://infinityblue.com) and sign in with your account.
  </Step>
...
<Steps>
  ...
  <Step title="Confirm the base URL">
    Make sure you are sending requests to `https://api.infinityblue.com/v1` and not a sibling host. Different environments have different key namespaces.
  </Step>
</Steps>
